...
class TodoCardFilter extends StatelessWidget {
  final String label;
  final TaskFilterEnum taskFilterlabel;
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async => await context
          .read<HomeController>()
          .findTasks(filter: taskFilterlabel),
